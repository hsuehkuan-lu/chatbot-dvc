...
class Trainer(BaseTrainer):
    ...
    Trainer class
    """
    def __init__(self, encoder, decoder, criterion, metric_ftns, optimizer, config, padding_idx, data_loader,
                 valid_data_loader=None, lr_scheduler=None, len_epoch=2):
        super().__init__(encoder, criterion, metric_ftns, optimizer, config)
        self.config = config
